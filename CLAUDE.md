...
**이슈 에스컬레이션 프로토콜:**
- **허용:** 이슈 사실 기록 (무엇이 발생했고, 무엇이 예상과 달랐는가), 관련 문서/근거 수집 및 첨부
- **금지:** 근본 원인 심층 분석 (Architect 영역), 거버넌스 변경 제안 (Director/Architect 영역)
- **의무:** Director에게 즉시 에스컬레이션 — [사실] + [관련 문서] + [판단 요청] 형식
...
| **Phase 내 작업 승인 (WO → APPROVED)** | **R/A** | I | — | — | — | — | — | — |
| **Phase 전환 승인 (N → N+1)** | **A** | I | **R** | I | C | I | I | I |
