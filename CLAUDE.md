...
| 버전 | 일시 | 변경 내용 |
|:--|:--|:--|
| **v3.0** | 2026-02-16 | D-030 반영: PM+DocManager 통합, Sonnet 배정. 섹션 7.1/7.2 통합, 7.7 RACI 갱신, 섹션 5 종료 프로토콜 통합. |
...
### 7.1 PM (Project Manager) — Doc Manager 통합
...
> **D-030 반영:** PM과 Doc Manager가 통합되어 PM 컬럼이 문서 관리 책임을 포함합니다.
...
| 문서 체계 검증/링크 유효성 | **A** | **R** | I | I | I | I | I |
| 최종 QA | **A** | I | C | I | **R** | I | I |
| **Phase 내 작업 승인 (WO → APPROVED)** | **R/A** | I | — | — | — | — | — |
| **Phase 전환 승인 (N → N+1)** | **A** | I | **R** | I | I | I | I |
