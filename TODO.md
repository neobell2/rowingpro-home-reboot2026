...
### 디자인 작업
- [ ] [Step 0] 디자인 아키텍처 확정 (PM/Architect)
  - 그리드, 컬러, 쉐이프 시스템 블루프린트 박제
- [ ] Draft 03 메인 페이지 구체화
  - 동영상 배경 적용 (docs/design/Hero_bg.webm / Hero_bg.mp4)
  - 레이아웃 최종 확정 (디렉터 승인 필수)
  - 반응형 테스트
...
**리소스:**
- `public/logo.svg` - 로고
- `docs/design/Hero_bg.webm` / `Hero_bg.mp4` - 동영상 배경 (최종 시안용)
- `참고자료/3D캡처렌더링모음/` - 원본 리소스 백업
- `Design_ref/` - 로고 원본 등
...
**마지막 업데이트:** 2026-02-12 18:08 (PM 업데이트)
